...
### 쪽지 보내기 버튼
 ...
 1등급만 이용 가능한 벙글장터와 만남의광장 상세조회 페이지에 쪽지보내기 아이콘이 생긴다.<br>
...
받는 사람의 이름에 게시글을 작성한 회원의 닉네임이 보이게 된다.<br>
회원번호는 hidden으로 숨겨져있다.<br>
...
내용을 클릭하면 메세지가 읽어진다.<br>
AJAX를 통해서 메세지 읽음 상태가 변경된다.<br>
...
답장하기 버튼과 닉네임을 클릭하면 쪽지 보내기 창이 열린다.<br>
...
메세지를 체크한 후 삭제 버튼을 누르면 AJAX를 통해 메세지가 삭제된다.<br>
