        ...
        <form action="#" method="POST" onsubmit="return memberJoinvalidate();">
            <div class="memberJoin">
                ...
                <div>
                    ...
                    <div class="ip">
                        <input type="text" class="display-ib email"  id="email1" name="" autocomplete="off" required> 
                        &nbsp;@&nbsp;
                        <select class="display-ib email" id="email2" name="" required>
                    ...
                    <div class="ip display-ib">
                        <input type="text" class="email" id="verifyEmail" placeholder="인증번호를 입력해주세요." 
                                style="background-color: rgb(196, 195, 195);"    readonly="true" required>
                    </div>
                    <div class= "btn display-ib">
